...
const RegisterScreen = ({type, navigation}) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.masuk}><TouchableOpacity onPress={() => navigation.navigate('Home')}><Text style={styles.textmasuk}>MASUK</Text></TouchableOpacity></View>
            </View>
            <View style={styles.agreement}>
                <Text style={{fontFamily:'Poppins-Regular', color:'#A0A0A0', marginLeft:10}}>Lupa Password ?</Text>    
            </View>
            </ScrollView>
            </View>
    )
